...
public:
    ...
    math::Vec2d projection(math::Vec3d const & p3d){
         ...
         */
        math::Vec3d res;
        res[0] = R_[0] * p3d[0] + R_[1] * p3d[1] + R_[2] * p3d[2];
        res[1] = R_[3] * p3d[0] + R_[4] * p3d[1] + R_[5] * p3d[2];
        res[2] = R_[6] * p3d[0] + R_[7] * p3d[1] + R_[8] * p3d[2];
        res[0] += t_[0]; res[1] += t_[1]; res[2] += t_[2];
        
        math::Vec2d p0;
        p0[0] = res[0] / res[2]; p0[1] = res[1] / res[2];
        double r2 =  p0[0] * p0[0] + p0[1] * p0[1];
        double r4 = r2 * r2;
        double s = (1 + dist_[0] * r2 + dist_[1] * r4);
